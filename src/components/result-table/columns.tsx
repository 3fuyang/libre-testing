...
export const columns: ColumnDef<TestResultItem>[] = [
    ...
    cell: ({ row }) => {
      ...
      return (
        <Flex align="center" gap='1'>
          {passed ? <CheckIcon className="size-4 text-green-500" /> : <Ban className="size-4 text-red-500" />}
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Ellipsis content={formattedDuration} />
      )
    }
  },
]
